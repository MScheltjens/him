            ...
            <Container className="space-y-10">
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    {services.map((service) => (
                        <Card key={service.title} className="group border-steel-200 bg-background shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:border-primary/40">
                            <CardContent className="space-y-5 p-6">
                                <div className="inline-flex border-2 border-steel-200 bg-steel-50 p-3">
                                    <service.icon className="h-6 w-6 text-steel-700" />
                                </div>
